...
const MemberCard = ({ member }) => {
  ...
  return (
    <div className="p-4" bis_skin_checked="1">
      <div
      ...
      >
        ...
        <div className="w-full" bis_skin_checked="1">
          <h2 className="title-font font-medium text-xl lg:text-2xl text-gray-900">
            {name}
          </h2>
          <h3 className="text-gray-500 mb-3 font-medium">{role}</h3>
