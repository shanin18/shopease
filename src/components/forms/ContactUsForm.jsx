  ...
  return (
    <form onSubmit={handleContactForm} className="space-y-8">
      ...
      <textarea
        ...
        required
        placeholder="Message"
        className="w-full bg-gray-100 rounded focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-36 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out "
      ></textarea>
